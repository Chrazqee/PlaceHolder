...
# 1. model 是 crop 的情况：
#   - inputs:  image_path_list = ["view_001.jpg", "view_002.jpg", ..., "view_100.jpg"]
#   - outputs: torch.Tensor with shape: (100, 3, H, W) where: H, W = 518, 518

# 2. mode 是 pad 的情况：
#   - inputs:  image_path_list = ["view_001.jpg", "view_002.jpg", ..., "view_100.jpg"]
#   - outputs: images.shape = (100, 3, H_max, W_max)
